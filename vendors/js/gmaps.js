...
!function (e, t) {
    ...
    var t, o, n = function (e, t) {
        ...
        var t = document, o = function (e) {
            ...
            var r, i = function (e, t) {
                ...
                g = e.el || e.div, h = e.markerClusterer, u = google.maps.MapTypeId[e.mapType.toUpperCase()],
                d = new google.maps.LatLng(e.lat, e.lng), m = i(e.zoomControl, !0),
                f = e.zoomControlOpt || {style: "DEFAULT", position: "TOP_LEFT"}, y = f.style || "DEFAULT",
                v = f.position || "TOP_LEFT", w = i(e.panControl, !0), k = i(e.mapTypeControl, !0),
                L = i(e.scaleControl, !0), b = i(e.streetViewControl, !0), _ = i(_, !0), M = {},
                x = {zoom: this.zoom, center: d, mapTypeId: u}, C = {
                    panControl: w,
                    zoomControl: m,
                    zoomControlOptions: {style: google.maps.ZoomControlStyle[y], position: google.maps.ControlPosition[v]},
                    mapTypeControl: k,
                    scaleControl: L,
                    streetViewControl: b,
                    overviewMapControl: _
                };
            if ("string" == typeof e.el || "string" == typeof e.div ? g.indexOf("#") > -1 ? this.el = l(g, e.context) : this.el = function (e, t) {
                var o = e.replace(".", "");
            ...
            var O = function (e, t) {
                var o = "", n = window.context_menu[s.el.id][e];
                ...
                if (l("gmaps_context_menu")) {
                    ...
                    var h = function (e) {
                        ...
                        return [t, o]
                    }.apply(this, [s.el]), u = h[0] + t.pixel.x - 15, d = h[1] + t.pixel.y - 15;
            ...
            this.buildContextMenu = function (e, t) {
                ...
                for (o in e.options) if (e.options.hasOwnProperty(o)) {
                    var r = e.options[o];
                    window.context_menu[s.el.id][e.control][r.name] = {title: r.title, action: r.action}
                }
                n.id = "gmaps_context_menu", n.style.display = "none", n.style.position = "absolute", n.style.minWidth = "100px", n.style.background = "white", n.style.listStyle = "none", n.style.padding = "8px", n.style.boxShadow = "2px 2px 6px #ccc", l("gmaps_context_menu") || t.body.appendChild(n);
    ...
    return p.prototype.createControl = function (e) {
        ...
        var t = this, o = e.details, r = e.fences, i = e.outside,
            s = {position: new google.maps.LatLng(e.lat, e.lng), map: null}, a = n(s, e);
        ...
        if (void 0 === e) {
            ...
            for (o = 0; o < e.length; o++) {
                ...
                if (n > -1) (r = this.markers[n]).setMap(null), this.markerClusterer && this.markerClusterer.removeMarker(r), p.fire("marker_removed", r, this)
            }
        ...
        return t.setMap(this.map), null != e.auto_show && (o = e.auto_show), t.onAdd = function () {
            ...
            var n, r, i = this.getPanes(), s = ["contextmenu", "DOMMouseScroll", "dblclick", "mousedown"];
        ...
        for (var o = new google.maps.Polygon(e), s = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], l = 0; l < s.length; l++) !function (t, o) {
            e[o] && google.maps.event.addListener(t, o, function (t) {
                e[o].apply(this, [t])
            })
        }(o, s[l]);
        ...
        (new google.maps.DirectionsService).route(r, function (t, o) {
            if (o === google.maps.DirectionsStatus.OK) {
                for (var n in t.routes) t.routes.hasOwnProperty(n) && i.push(t.routes[n]);
        ...
        (e = n({
            ...
            path: !1,
            samples: 256
        }, e)).locations.length > 0 && e.locations[0].length > 0 && (e.locations = i(r([e.locations], a, !1)));
        var t = e.callback;
        delete e.callback;
        ...
        var o, r = "string" == typeof t.panel ? document.getElementById(t.panel.replace("#", "")) : t.panel;
        t.panel = r, t = n({map: this.map}, t), o = new google.maps.DirectionsRenderer(t), this.getRoutes({
            origin: e.origin,
        ...
        delete e.styles;
        var s = e.polyline;
        if (delete e.polyline, e.center) o.push("center=" + e.center), delete e.center; else if (e.address) o.push("center=" + e.address), delete e.address; else if (e.lat) o.push(["center=", e.lat, ",", e.lng].join("")), delete e.lat, delete e.lng; else if (e.visible) {
        ...
        if (r) for (var g, h, u = 0; t = r[u]; u++) {
            for (var c in g = [], t.size && "normal" !== t.size ? (g.push("size:" + t.size), delete t.size) : t.icon && (g.push("icon:" + encodeURI(t.icon)), delete t.icon), t.color && (g.push("color:" + t.color.replace("#", "0x")), delete t.color), t.label && (g.push("label:" + t.label[0].toUpperCase()), delete t.label), h = t.address ? t.address : t.lat + "," + t.lng, delete t.address, delete t.lat, delete t.lng, t) t.hasOwnProperty(c) && g.push(c + ":" + t[c]);
        ...
        if (i) for (u = 0; u < i.length; u++) {
            ...
            for (var m = 0; m < i[u].stylers.length; m++) for (var f in i[u].stylers[m]) {
                var y = i[u].stylers[m][f];
                "hue" != f && "color" != f || (y = "0x" + y.substring(1)), d.push(f + ":" + y)
            }
            var v = d.join("|");
            "" != v && o.push("style=" + v)
        }
